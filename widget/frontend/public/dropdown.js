...
$.widget( "ui.tmDropdown", {
    ...
    _create: function() {
        ...
        $('body').append( '<a href="javascript://" style="position:absolute;left:-2000px">&nbsp;</a>' );
...
//        console.log( 'option kd', event );
        ...
        case 9:
            ...
            // immediately return.  since the event it not stopped and we've
            // changed focus to the dropdown, the tab key will be processed and
            // advance the focus off the dropdown correctly
            this._reset_search();
            event.stopPropagation();
            return;
            break;
...
//        console.log( 'dropdown kd', event );
        ...
        case 38:
            if ( this.options.role == "combobox" ) {
              ...
              // blur/focus the dropdown so that IE8 will read the new option
              this._dropdown.blur();
              this._dropdown.focus();
            }
            else {
    ...
    _adjust_expanded_width: function() {
        var dropdown_width = this.element.width();
        ...
        if ( list_width < dropdown_width ) {
            this._options_layer.width( dropdown_width - 4 );
        }
